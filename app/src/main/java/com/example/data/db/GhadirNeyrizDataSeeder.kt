    ...
    suspend fun seedGhadirNeyrizOverhaul(dao: OverhaulDao) {
        ...
        val samplePermits = listOf(
            SafetyPermitEntity(
                ...
                requestDate = "1404/10/14",
                issueDate = "1404/10/14",
                validHours = 12,
                expiryTimestamp = System.currentTimeMillis() + (12 * 3600 * 1000L),
                requestedByUserId = 6,
                requestedByUserName = "مهندس اله بخش",
                unitHeadApproved = true,
                unitHeadApprovedBy = "مهندس حیدری (مکانیک)",
                issuedByUserId = 18,
                ...
                gasTestResultO2 = "20.9%",
                gasTestResultCO = "0 ppm",
                gasTestResultLEL = "0%",
                gasTesterName = "مهندس محب ایران",
                lastGasTestTimestamp = "08:15",
            ...
            SafetyPermitEntity(
                ...
                issueDate = "1404/10/14",
                validHours = 24,
                expiryTimestamp = System.currentTimeMillis() + (24 * 3600 * 1000L),
                requestedByUserId = 8,
                ...
                requiresGasTest = true,
                gasTestResultO2 = "20.8%",
                gasTestResultCO = "0 ppm",
                gasTestResultLEL = "0%",
                gasTesterName = "مهندس محب ایران",
                lastGasTestTimestamp = "08:30",
            ...
            SafetyPermitEntity(
                ...
                issueDate = "1404/10/14",
                validHours = 8,
                expiryTimestamp = System.currentTimeMillis() + (8 * 3600 * 1000L),
                requestedByUserId = 16,
                requestedByUserName = "مهندس ضیغمی",
                unitHeadApproved = true,
                unitHeadApprovedBy = "مهندس ضیغمی (انرژی و سیالات)",
            ...
            SafetyPermitEntity(
                ...
                unitHeadApproved = true,
                unitHeadApprovedBy = "مهندس یادگار (برق)",
                issuedByUserId = 0L,
                issuedByUserName = "",
                requiresElectricalLoto = true,
